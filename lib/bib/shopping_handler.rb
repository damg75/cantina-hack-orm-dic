        ...
        loop do
            ...
            case selector
                when 'y'
                    ...
                    system('clear')
                    puts "Su saldo disponible: #{client_shopper.client_balance}" 
                    puts
                    ...
                    case selector
                        when 'y'
                            if client_shopper.client_balance >= sale_price
                                ...
                                client_shopper = Client.find_by(id: client_shopper.id) #Refresca el cliente
                                shopping_cart << sale
                            else   
                ...
                when 'n'
                    ...
                    if shopping_cart.size > 0
                        ...
                        invoice.sales.each do |sale|
                            aux_array << sale.sale_price
                        end
                        puts
                        puts "El total de su compra es:  #{aux_array.inject(0){|sum,x| sum + x }} "
                    else
